...
from Weed.predict_weed import predict
import base64
import re
from Weed.alert import message 

class Ping(Resource):
    def get(self):
        return "working"

class Item_Weed(Resource):
    ...
    def post(self):
        ...
        filepath = 'Weed/temp_images/'+filename
        # print(type(imgdata))
        # print("img_data=\n", imgdata)
        ...
        if('message' in result.keys()):
            ...
            # print(type(WeedProductModel.find_product(weed_name,data['crop'].title(), data['country'].title())))
